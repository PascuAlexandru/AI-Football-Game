 ...
 */
public class PlayerChelsea extends Character
{
     ...
     */
    public PlayerChelsea(RefLinks refLink, float x, float y, byte id, boolean GK)
    {
                            ...
                            if(shoot){
                                if(ball.GetX() > x - width) {
                                    ...
                                    if (goal) {
                                        goal = false;
                                        if (ball.GetY() < Map.height / 2)
                                            RightGoal.SetAnimation(48, (byte) 1); /////////////// RightGoal*
                                        else
                                            RightGoal.SetAnimation(48, (byte) 2); /////////////// RightGoal*
                                        image = Assets.heroLeft4; // Animatie pentru aruncare
                                        fanion = 24;
                                    } else {
                                        HasBall = true;
