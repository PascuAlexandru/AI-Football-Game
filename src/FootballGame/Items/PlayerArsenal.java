                ...
                else // Daca are mingea, actioneaza in consecinta
                {
                    ...
                    if(pressingContor > 45){
                        ...
                        if(passToLinkUpPlayer){
                            ...
                            {
                                //if(Math.abs(Player[aux].GetX()-x)/Math.abs(Player[aux].GetY()-y))
                            }// pasa to attacker
                            else
                            {
                                ball.setDirection(true);
                                ...
                                Ball.actualizareX = (Player[linkUpPlayerID].GetX()-x)/55;
                                Ball.actualizareY = (Player[linkUpPlayerID].GetY()-y)/55;
                                behavior="Link Up Player";
                                HasBall = false;
                                Player[linkUpPlayerID].behavior = "Receive Ball";
                            }//pasa to link up
                    ...
                    Node goal = new Node(3, 7); // Poziția de țintă (poarta adversa)
